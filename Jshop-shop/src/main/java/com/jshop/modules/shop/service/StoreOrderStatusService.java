 ...
 * @author jack胡
 */
public interface StoreOrderStatusService extends BaseService<StoreOrderStatus>{
...
/**
    ...
    */
    List<StoreOrderStatus> queryAll(StoreOrderStatusQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<StoreOrderStatusDto> all, HttpServletResponse response) throws IOException;
}
