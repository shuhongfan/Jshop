 ...
 * @author jack胡
 */
public interface StoreCartService extends BaseService<StoreCart>{
...
/**
    ...
    */
    Map<String,Object> queryAll(StoreCartQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<StoreCart> queryAll(StoreCartQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<StoreCartDto> all, HttpServletResponse response) throws IOException;
