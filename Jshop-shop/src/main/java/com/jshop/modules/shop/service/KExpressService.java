 ...
 * @author jack胡
 */
public interface KExpressService extends BaseService<Express>{
...
/**
    ...
    * @return List<Express>
    */
    List<Express> queryAll(ExpressQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<ExpressDto> all, HttpServletResponse response) throws IOException;
}
