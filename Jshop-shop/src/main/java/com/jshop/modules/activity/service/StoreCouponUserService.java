 ...
 * @author jack胡
 */
public interface StoreCouponUserService extends BaseService<StoreCouponUser>{
...
/**
    ...
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<StoreCouponUserDto>
    */
    List<StoreCouponUser> queryAll(StoreCouponUserQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<StoreCouponUserDto> all, HttpServletResponse response) throws IOException;
}
