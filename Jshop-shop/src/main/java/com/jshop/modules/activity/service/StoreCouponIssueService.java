 ...
 * @author jack胡
 */
public interface StoreCouponIssueService extends BaseService<StoreCouponIssue>{
...
/**
    ...
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<StoreCouponIssue>
    */
    List<StoreCouponIssue> queryAll(StoreCouponIssueQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<StoreCouponIssueDto> all, HttpServletResponse response) throws IOException;
}
